...
De groei aan rechts-populistische bewegingen in Europa en de Verenigde
...
uyoku} (ネット右翼, net-rechts), ruwweg vertaald als de rechtse internetstem. Deze
...
Makoto, en de rechtse internetstem als het te mobiliseren electoraat. Door
middel van een sociale identiteitsbenadering geeft deze paper een eerste
aanzet om het gedrag van die net-rechtse beweging te verklaren, en poogt zo
...
spilfiguur binnen de net-rechtse beweging, en staaft een kwantitatieve
...
die eerder vermelde nativistische en reactionaire populistische ideologieën.
...
\afterpage{%
    \clearpage% Flush earlier floats (otherwise order might not be correct)
        \begin{figure}
  \centering
    \includegraphics{images/infograph_screenshot.jpg}
    \centering\caption{Screenshot van de interactieve infographic samengesteld met Tableau.}
\end{figure}
